...
class EMS:
    ...
    def run(self, parameter_dict, simulation_dict):
        ...
        while day_num:
            ...
            # Add DA forecasts to dynamic_inputs for spot market optimization
            dynamic_inputs["DA_wind_forecast"] = DA_wind_forecast
            dynamic_inputs["DA_solar_forecast"] = DA_solar_forecast
